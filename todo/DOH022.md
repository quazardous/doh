...
**Dependencies**: DOH013 (completed), DOH018 (completed), DOH026 (restructure)  
...
(DOH003), serves as reference implementation, and provides isolated testing environment. The DOH system should "eat its
