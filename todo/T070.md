# T070 - Enforce Strict Linting in /dd:commit with Bypass Control 🔒
...
❌ Markdown linting failed: 5 errors found
...
❌ COMMIT BLOCKED: Critical linting errors must be fixed before committing.
