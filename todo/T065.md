# T065 - Beautify /doh-sys Commands with Dynamic Flag Auto-completion & Help 🌟
...
Enhance all `/doh-sys` commands with beautiful, intelligent auto-completion that dynamically shows available flags, contextual help, and usage examples while the user is typing. This creates a modern CLI experience with immediate feedback and guidance.
...
├── commands/
│   ├── doh-sys/
│   │   ├── commit.md (+ native frontmatter)
│   │   ├── next.md (+ native frontmatter)  
│   │   ├── changelog.md (+ native frontmatter)
│   │   └── lint.md (+ native frontmatter)
│   │
│   ├── doh/ (existing runtime commands)
│   │
│   ├── commit-split.md (NEW - shortcut command)
│   ├── commit-interactive.md (NEW - shortcut command)
│   ├── next-quick.md (NEW - shortcut command)
│   ├── next-docs.md (NEW - shortcut command)
│   └── next-features.md (NEW - shortcut command)
│
└── doh/
    ├── templates/
    │   └── command_template.md (+ frontmatter template)
    │
    └── inclaude.md (+ shortcut documentation)
```
