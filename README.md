# D'oh Project Managment

AI Project Manager for Homer.

Freely ~~copied~~ inspired from [CCPM](https://github.com/automazeio/)
...
/doh:epic-oneshot memory-system
/doh:issue-start 1235
```

## What Makes This Different?

| Traditional Development | DOH System |
|------------------------|----------------------|
| Context lost between sessions | **Persistent context** across all work |
| Serial task execution | **Parallel agents** on independent tasks |
| "Vibe coding" from memory | **Spec-driven** with full traceability |
| Progress hidden in branches | **Transparent audit trail** in GitHub |
| Manual task coordination | **Intelligent prioritization** with `/doh:next` |
...
**Output:** `.doh/epics/feature-name/epic.md`

### 3. Task Decomposition Phase

```bash
/doh:epic-decompose feature-name
```
Breaks epic into concrete, actionable tasks with acceptance criteria, effort estimates, and parallelization flags.

**Output:** `.doh/epics/feature-name/[task].md`

### 4. GitHub Synchronization

```bash
/doh:epic-sync feature-name
# Or for confident workflows:
/doh:epic-oneshot feature-name
```
...
```bash
/doh:issue-start 1234  # Launch specialized agent
/doh:issue-sync 1234   # Push progress updates
/doh:next             # Get next priority task
```
...
> [!TIP]
> Type `/doh:help` for a concise command summary
...
### Epic Commands
- `/doh:epic-decompose` - Break epic into task files
- `/doh:epic-sync` - Push epic and tasks to GitHub
- `/doh:epic-oneshot` - Decompose and sync in one command
- `/doh:epic-list` - List all epics
- `/doh:epic-show` - Display epic and its tasks
- `/doh:epic-close` - Mark epic as complete
- `/doh:epic-edit` - Edit epic details
- `/doh:epic-refresh` - Update epic progress from tasks

### Issue Commands
- `/doh:issue-show` - Display issue and sub-issues
- `/doh:issue-status` - Check issue status
- `/doh:issue-start` - Begin work with specialized agent
- `/doh:issue-sync` - Push updates to GitHub
- `/doh:issue-close` - Mark issue as complete
- `/doh:issue-reopen` - Reopen closed issue
- `/doh:issue-edit` - Edit issue details

### Workflow Commands
- `/doh:next` - Show next priority issue with epic context
...
- `/doh:import` - Import existing GitHub issues
...
/doh:issue-analyze 1234

# Launch the swarm
/doh:epic-start memory-system
...
/doh:epic-merge memory-system
```

## Key Features & Benefits

### 🧠 **Context Preservation**
Never lose project state again. Each epic maintains its own context, agents read from `.doh/context/`, and updates locally before syncing.
...
1. **Install this repository into your project**:
   ...
   # or: wget -qO- https://raw.githubusercontent.com/quazardous/doh/main/doh.sh | bash
   ```
   ...
   See full/other installation options in the [installation guide ›](https://github.com/quazardous/doh/tree/main/install)


2. **Initialize the DOH system**:
   ```bash
   /doh:init
   ```
   This command will:
...
The original CLaude Code DOH was developed at [Automaze](https://automaze.io) **for developers who ship, by developers who ship**.

If DOH helps your team ship better software:
