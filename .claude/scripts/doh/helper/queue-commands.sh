...
# Queue management commands for DOH message queue system
# Provides CLI interface for queue operations
...
cmd_queue() {
    ...
    case "$subcommand" in
        ...
        *)
            ...
            echo "==========================="
            echo ""
            echo "Usage: queue <command> [options]"
            echo ""
            echo "Commands:"
...
# Export the main command function
