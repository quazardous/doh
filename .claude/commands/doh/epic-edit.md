...
Read `.doh/epics/$ARGUMENTS/epic.md`:
- Parse frontmatter
...
If yes:
```bash
gh issue edit {issue_number} --body-file .doh/epics/$ARGUMENTS/epic.md
```
...
View epic: /doh:epic-show $ARGUMENTS
```
