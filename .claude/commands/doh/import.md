...
Import existing GitHub issues into the DOH system.

## Usage
```
/doh:import [--epic <epic_name>] [--label <label>]
```
...
- No DOH labels → Ask user or create in "imported" epic
...
Next steps:
  Run /doh:status to see imported work
  Run /doh:sync to ensure full synchronization
```
