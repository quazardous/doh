...
This command updates the project context documentation in `.doh/context/` to reflect the current state of the project. Run this at the end of each development session to keep context accurate.
...
**File Modifications:**
- Check context file ages: `find .doh/context -name "*.md" -type f -exec ls -lt {} + | head -5`
